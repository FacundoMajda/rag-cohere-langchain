...
export async function researcher(query: string): Promise<any> {
  ...
  const prompt = ChatPromptTemplate.fromMessages([
    [
      "system",
      "Eres un asistente muy útil. Siempre darás respuestas claras y detalladas, haciendo enfasis en la información importante encontrada, siempre ofreceras una breve introduccion y una breve conclusión con consideraciones finale",
    ],
